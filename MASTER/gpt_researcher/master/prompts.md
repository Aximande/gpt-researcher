from datetime import datetime, timezone import warnings from
...
def auto_agent_instructions(): return """ This task involves researching
...
def generate_subtopics_prompt() -\> str: return """ Provided the main
topic:
