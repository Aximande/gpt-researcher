...
\| apt-key add - RUN echo "deb http://dl.google.com/linux/chrome/deb/
stable main" \>\> /etc/apt/sources.list.d/google.list RUN apt-get update
&& apt-get install -y google-chrome-stable

# Download and extract the appropriate version of Chromedriver

ENV CHROMEDRIVER_VERSION 113.0.5672.63 RUN mkdir -p /chromedriver\
